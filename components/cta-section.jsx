    ...
    return (
        <section className="py-10 md:py-14 bg-[#d49e17]">
            <div className="container mx-auto px-4 md:px-8 lg:px-12 text-center">
                <h2 className={`${poppins.className} text-2xl md:text-3xl lg:text-4xl text-white mb-3 font-semibold uppercase`}>
                    GET THE INSIGHTS THAT MATTER
                </h2>
                <p className={`${poppins.className} text-base md:text-lg text-white/90 mb-6 max-w-xl mx-auto uppercase`}>
